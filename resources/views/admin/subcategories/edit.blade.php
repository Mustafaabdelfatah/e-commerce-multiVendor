                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('sub_categories.update',$subCategory -> id)}}"
                                              method="POST"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="parent_id" class="form-control">
                                                            ...
                                                            <option
                                                                value="{{$level->id}}"
                                                                @if($level->id == $subCategory->parent_id )  selected @endif >
                                                                {{$level->name}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> 
                                                                - {{__('messages.'.'cat'.$subCategory->translation_lang)}} </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1"> {{__('messages.'.'act'.$subCategory -> translation_lang)}} </label>
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                            ...
                                            @isset($subCategory -> categories)
                                                ...
                                                <form class="form"
                                                      action="{{route('sub_categories.update',$translation -> id)}}"
                                                      method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    @method('put')
