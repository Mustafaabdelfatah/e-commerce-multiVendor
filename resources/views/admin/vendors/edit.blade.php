                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('main_categories.update',$mainCategory -> id)}}"
                                              method="POST"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> 
                                                                - {{__('messages.'.'cat'.$mainCategory->translation_lang)}} </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1"> {{__('messages.'.'act'.$mainCategory -> translation_lang)}} </label>
